...
layout: course
title: "Readme"
permalink: /2_LLM_Core/llm-from-scratch-10weeks/code/README.html
---
...
```bash
python 2_LLM_Core/llm-from-scratch-10weeks/code/python/mini_gpt_lab.py
```

Biên dịch C++:

```bash
clang++ -std=c++17 -O2 2_LLM_Core/llm-from-scratch-10weeks/code/cpp/byte_tokenizer.cpp -o /tmp/byte_tokenizer
