...
layout: course
title: "Week05"
permalink: /3_FineTuning/openweight-finetuning-10weeks/lessons/week05.html
---

# Tuần 5 — Cấu hình LoRA và QLoRA / Week 5 — LoRA and QLoRA configuration

[← Tuần 4](week04.md) · [Mục lục khoá](../INDEX.md) · [40 tuần](../../../courses/WEEK_INDEX.md) · [Lịch 20 buổi](../schedule.md) · [Tuần 6 →](week06.md)
...
**Unsloth cụ thể / Unsloth specifics:** chọn bản `unsloth-...-unsloth-bnb-4bit` (dynamic 4-bit, độ mất accuracy so với LoRA 16-bit gần như được khôi phục); bật `load_in_4bit=True` cho QLoRA, `load_in_16bit=True` cho LoRA, `full_finetuning=True` chỉ khi thật cần. Nghiên cứu cho thấy **train và serve cùng precision** giúp giữ accuracy. Chi tiết: [Công nghệ Unsloth](../references/unsloth-technology.md).
