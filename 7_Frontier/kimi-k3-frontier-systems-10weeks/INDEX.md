...
layout: course
title: "Index"
permalink: /7_Frontier/kimi-k3-frontier-systems-10weeks/INDEX.html
---

# Kimi K3: kiến trúc frontier và hệ thống agent / Frontier Architecture & Agent Systems

[Danh mục khoá ngắn](../../courses/README.md) · [Chỉ mục 40 tuần](../../courses/WEEK_INDEX.md) · [Lịch 20 buổi](schedule.md) · [Phân tích technical report](TECHNICAL_REPORT.md) · [Hướng dẫn repository](REPOSITORY_GUIDE.md) · [Đồ án](projects/final_project.md)

[Code lab](code/README.md) · [Yêu cầu máy tính](../../courses/COMPUTER_REQUIREMENTS.md) · [Nguồn chính thức](references/README.md)
