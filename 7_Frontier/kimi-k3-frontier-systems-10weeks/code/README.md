...
layout: course
title: "Readme"
permalink: /7_Frontier/kimi-k3-frontier-systems-10weeks/code/README.html
---
...
python 7_Frontier/kimi-k3-frontier-systems-10weeks/code/python/model_scale_estimator.py
python 7_Frontier/kimi-k3-frontier-systems-10weeks/code/python/toy_kda.py
python 7_Frontier/kimi-k3-frontier-systems-10weeks/code/python/toy_attnres.py
python 7_Frontier/kimi-k3-frontier-systems-10weeks/code/python/quantile_balancing.py
python 7_Frontier/kimi-k3-frontier-systems-10weeks/code/python/agent_verifier.py
python 7_Frontier/kimi-k3-frontier-systems-10weeks/code/python/preserved_history_payload.py
```
