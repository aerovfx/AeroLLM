# THỰC HÀNH DỰ ÁN — CHỈ MỤC TÀI LIỆU
> **Mục tiêu:** Cung cấp hướng dẫn cài đặt mã nguồn mẫu, thiết lập Notebook Google Colab và theo dõi các chỉ số huấn luyện mô hình.
...
3.  **Mã nguồn mẫu của mô hình:**
    *   **[mini_gpt.py (Mã nguồn Python)](file:///Users/dangvietchung/Aero-HowtoLLMs/docs/mini_gpt.py):** File code ~150 dòng PyTorch tối giản dùng chạy offline trên máy tính hoặc Colab.
    *   **[mini_gpt.ipynb (Google Colab Notebook)](file:///file:///Users/dangvietchung/Aero-HowtoLLMs/docs/mini_gpt.ipynb):** Phiên bản sổ tay tương tác, thuận tiện cho giảng dạy trình chiếu.
